...
| `AMOUNT`       | `неотрицательное целое (64-бит)` | Неотрицательная сумма транзакции в наименьших единицах валюты (например, в центах). Направление операции задаётся полем `TX_TYPE`. |
