...
| `AMOUNT` | 8 байт | беззнаковое 64-битное | Неотрицательная сумма в наименьшей денежной единице (центах). Направление операции задаётся полем `TX_TYPE`, а не знаком суммы. |
